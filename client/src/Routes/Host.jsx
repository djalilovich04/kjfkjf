      ...
      <div className="host-form-content-wrapper">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="paymentMeth">
            ...
            <button
              type="button"
              onClick={() => {handlepayment_type("ccp");setIsCCP(true);setIsEdahabia(false)}}
              className={
            ...
            <button
              type="button"
              onClick={() => {handlepayment_type("credit_card");setIsEdahabia(true);setIsCCP(false)}}
              className={
          ...
          <div>
       {isCCP && (
        <div className="CCPForm" style={{marginTop:'100px',marginLeft:'230px'}}>
        ...
        maxLength={10}
          placeholder='Account'
            ...
            <br />
            <br />
             <div className='disclaimer' style={{marginTop:'5px',marginLeft:'170px',color:'black',display:'inline-flex'}}>
             <FaLock /> &nbsp; Payments are secure and encrypted</div>
        </div>
      )}
      {/*//////////EDAHABIA/////////*/}
      {isEdahabia && (
        <div className="CreditCardForm" style={{marginTop:'100px',marginLeft:'230px'}}>
        ...
        maxLength={19}
          placeholder='0000 0000 0000 0000'
            title="Please enter only numbers"/>
            <FaCreditCard style={{marginLeft:'445px',marginTop:'9px',position:'absolute'}}/>
            </div>
